...
namespace TransformHandles
{
    public class TransformHandleManager : Singleton<TransformHandleManager>
    {
        ...
        [Header("Shortcuts")]
        [SerializeField] private bool useKeyboardShortcuts = false;
        ...
        protected virtual void MouseInput()
        {
            ...
            if (Mouse.current.leftButton.wasPressedThisFrame && _hoveredHandle != null)
            {
